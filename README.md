...
- When you omit `-Config`, every positional argument is treated as an input file; use `-Config myrules.ini` (or `-c myrules.ini`) whenever you need to override the default `./deannon.ini`.
